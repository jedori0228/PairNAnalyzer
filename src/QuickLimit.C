...
void QuickLimit(int xxx=0){
  ...
  TString dirname = "MMandEE_bkgd50";
  ...
  TString XSEC_file = "script/2016SampleXsec/values_MG_NLO.txt";
  ...
  vector<int> ZPmasses = {500, 750, 1000, 1500, 2000, 2500, 3000, 4000};
...
*/
  ...
  vector<int> Nmasses = {100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800};
